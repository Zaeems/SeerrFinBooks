...
(function () {
    ...
    function renderCardActions(item) {
        ...
        if (mediaType === 'movie' && state.clientSettings?.radarrUrl) {
            ...
            if (radarrUrl) {
                html +=
                    '<button type="button" class="betterseerr-request-action-btn betterseerr-request-radarr-btn" ' +
        ...
        if (mediaType === 'tv' && state.clientSettings?.sonarrUrl) {
            ...
            if (sonarrUrl) {
                html +=
                    '<button type="button" class="betterseerr-request-action-btn betterseerr-request-sonarr-btn" ' +
    ...
    function bindContainerEvents(container) {
        ...
        container.addEventListener('click', function (event) {
            ...
            const radarrBtn = event.target.closest('.betterseerr-request-radarr-btn');
            if (radarrBtn) {
                event.preventDefault();
                event.stopPropagation();
            ...
            const sonarrBtn = event.target.closest('.betterseerr-request-sonarr-btn');
            if (sonarrBtn) {
                event.preventDefault();
                event.stopPropagation();
